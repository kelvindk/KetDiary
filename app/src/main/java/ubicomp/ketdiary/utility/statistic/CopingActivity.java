...
//                        ClickLog.Log(ClickLogId.COPING_SELECTION + skillSelect);
    ...
    private class RecreationOnClickListener implements OnClickListener {
...
//                        ClickLog.Log(ClickLogId.COPING_SELECTION + skillSelect);
    ...
    private void generateDialog(int textResource){
        ...
        dialogOKButton.setOnClickListener(new EndOnClickListener(dialog) );
    }
...
//                ClickLog.Log(ClickLogId.COPING_STOP);
    ...
    private class EndOnClickListener implements OnClickListener {
        ...
        /**
         *  Constructor with dialog passed in to avoid window leaked problem
         * @param dialog
         *            The dialog connected with this listener
         */
        EndOnClickListener(Dialog dialog) {
            this.dialog = dialog;
        }
        ...
        public void onClick(View v) {
            ...
            // Dismiss the dialog in order to avoid window leaked error
            // Dismiss the dialog earlier in order to avoid race condition with activity finish
            if (this.dialog != null)
                dialog.dismiss();
            ...
            if(addScore > 0) {
                AddScore nowScore = new AddScore(System.currentTimeMillis(), addScore, 0, "coping skill", 0, AddScore.COPYINGSKILL);
...
//            ClickLog.Log(ClickLogId.COPING_SELECTION);
    ...
    private class AnimCheckOnClickListener implements OnClickListener {
        private int selection;
...
//            ClickLog.Log(ClickLogId.COPING_END_PLAY);
    ...
    private class AnimCancelOnClickListener implements OnClickListener {
...
//            ClickLog.Log(ClickLogId.COPING_END_PLAY_CANCEL);
    ...
    private class CallCheckOnClickListener implements OnClickListener {
...
//	/** Used for canceling calling out */
    private class CallCancelOnClickListener implements OnClickListener {
        @Override
        public void onClick(View v) {
...
//            ClickLog.Log(ClickLogId.COPING_CALL_CANCEL);
    ...
    private class MusicTimer extends CountDownTimer {
        ...
        public void onTick(long millisUntilFinished) {
            if (bar != null) {
                LayoutParams barParam = (LayoutParams) bar.getLayoutParams();
