    ...
    public TestStateTransition transit(int trigger) {
        ...
        switch (trigger) {
            case BLE_NO_CASSETTE_PLUGGED:
                Log.d("TestState", "TestStateFinish BLE_NO_CASSETTE_PLUGGED");
            ...
            case BLE_DEVICE_DISCONNECTED:
                Log.d("TestState", "TestStateFinish BLE_DEVICE_DISCONNECTED");
            ...
            case BLE_CASSETTE_PLUGGED:
                Log.d("TestState", "TestStateFinish "+trigger);
                newState = this;
                break;
            ...
            case BLE_UPDATE_SALIVA_VOLTAGE:
                Log.d("TestState", "TestStateFinish BLE_UPDATE_SALIVA_VOLTAGE "+getSalivaTestAdapter().getSalivaVoltage());
                newState = this;
                break;
...
//
//                // Transit to TestStateFinishRespit and start startStage3RespitCountdown.
