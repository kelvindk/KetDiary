...
public class PreSettingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lPickDate.setOnClickListener(new OnClickListener() {
			@SuppressWarnings("deprecation")
			public void onClick(View v) {
...
//				resotreAlertDialogVer1));
		...
		triggerResetButton = (Button) this.findViewById(R.id.trigget_reset);
		triggerResetButton.setOnClickListener(new OnClickListener(){
...
//	}
	...
	private class DebugOnClickListener implements OnClickListener {
		@Override
		public void onClick(View v) {
			debug = !debug;
