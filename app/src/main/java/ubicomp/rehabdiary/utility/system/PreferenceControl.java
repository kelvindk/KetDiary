package ubicomp.rehabdiary.utility.system;
...
import ubicomp.rehabdiary.utility.data.structure.TimeValue;
...
public class PreferenceControl {
    ...
    private static final SharedPreferences sp = KetdiaryApplication.getSp();
...
//				KetdiaryApplication.getContext().getString(R.string.default_goal_good));
//	}
    ...
    public static int getAppPasswordAble() {
        return sp.getInt("AppPasswordAble", 0);
    }

    public static void setAppPasswordAble(int v) {
        SharedPreferences.Editor edit = sp.edit();
        edit.putInt("AppPasswordAble", v);
        edit.commit();
    }

    public static int getAppPassword() {
        return sp.getInt("AppPassword", 0);
    }

    public static void setAppPassword(int v) {
        SharedPreferences.Editor edit = sp.edit();
        edit.putInt("AppPassword", v);
        edit.commit();
    }
    ...
    public static long getLastestViewPage3ListTimestamp() {
        return sp.getLong("lastestViewPage3ListTimestamp", 0);
    }

    public static void setLastestViewPage3ListTimestamp(long v) {
        SharedPreferences.Editor edit = sp.edit();
    ...
    public static void setLastestViewPage3DetailTimestamp(long v) {
        SharedPreferences.Editor edit = sp.edit();
        edit.putLong("lastestViewPage3DetailTimestamp", v);
        edit.commit();
    }

    public static long getLastestViewPage4ListTimestamp() {
        return sp.getLong("lastestViewPage4ListTimestamp", 0);
    }

    public static void setLastestViewPage4ListTimestamp(long v) {
        SharedPreferences.Editor edit = sp.edit();
        edit.putLong("lastestViewPage4ListTimestamp", v);
        edit.commit();
    }

    public static long getLastestViewPage4DetailTimestamp() {
        return sp.getLong("lastestViewPage4DetailTimestamp", 0);
    }

    public static void setLastestViewPage4DetailTimestamp(long v) {
        SharedPreferences.Editor edit = sp.edit();
