package ubicomp.rehabdiary.utility.test.bluetoothle;
...
public class ImageDetection {
    ...
    private static final int WHITE_THRESHOLD = 230; //!!!
    ...
    private static final String model_directory_name = "SVM";
    //private static final String result_directory_name = "";
    ...
    @SuppressLint("Instantiatable")
	public ImageDetection(Activity activity, byte[] data, long ts) {
        ...
        model_directory = new File(mainStorage, model_directory_name);
        if (!model_directory.exists())
            model_directory.mkdirs();

        /*File mainStorageResult;
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED))
...
//        String output = svm_scale.svm_scale(scale_param_path.toString(), line);
    ...
    private Mat getROIRegionMat(Bitmap bitmap){
        ...
        boolean step2 = false;
        String name = "PIC_".concat(String.valueOf(timestamp.toString())).concat("_3.sob");
        ...
        if(!step2)
        {
        	name = "PIC_".concat(String.valueOf(timestamp.toString())).concat("_1.jpg");
        	file = new File(result_directory, name);
        }
        else
        {
        	name = "PIC_".concat(String.valueOf(timestamp.toString())).concat("_4.jpg");
            file = new File(result_directory, name);
        }
        try {
        ...
        {
        	name = "PIC_".concat(String.valueOf(timestamp.toString())).concat("_5.jpg");
            file = new File(result_directory, name);
        }
        try {
        ...
        {
        	name = "PIC_".concat(String.valueOf(timestamp.toString())).concat("_1.jpg");
        	name2 = "PIC_".concat(String.valueOf(timestamp.toString())).concat("_1.sob");
        }
        else
        {
        	name = "PIC_".concat(String.valueOf(timestamp.toString())).concat("_4.jpg");
        	name2 = "PIC_".concat(String.valueOf(timestamp.toString())).concat("_4.sob");
        }
        file = new File(result_directory, name);
        file2 = new File(result_directory, name2);
        ...
        {
        	name = "PIC_".concat(String.valueOf(timestamp.toString())).concat("_2.jpg");
        	name2 = "PIC_".concat(String.valueOf(timestamp.toString())).concat("_2.sob");
        }
        else
        {
        	name = "PIC_".concat(String.valueOf(timestamp.toString())).concat("_5.jpg");
        	name2 = "PIC_".concat(String.valueOf(timestamp.toString())).concat("_5.sob");
        }
