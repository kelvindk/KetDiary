 ...
 */
public class ScenarioIconClickListener implements View.OnClickListener {
    ...
    public ScenarioIconClickListener(CreateEventActivity createEventActivity) {
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()) {
            case R.id.scenario_button1:
                Log.d("Ket", "ScenarioIconClickListener "+view.getId()+" 1");
            ...
            case R.id.scenario_button2:
                Log.d("Ket", "ScenarioIconClickListener "+view.getId()+" 2");
            ...
            case R.id.scenario_button3:
                Log.d("Ket", "ScenarioIconClickListener "+view.getId()+" 3");
            ...
            case R.id.scenario_button4:
                Log.d("Ket", "ScenarioIconClickListener "+view.getId()+" 4");
            ...
            case R.id.scenario_button5:
                Log.d("Ket", "ScenarioIconClickListener "+view.getId()+" 5");
            ...
            case R.id.scenario_button6:
                Log.d("Ket", "ScenarioIconClickListener "+view.getId()+" 6");
            ...
            case R.id.scenario_button7:
                Log.d("Ket", "ScenarioIconClickListener "+view.getId()+" 7");
            ...
            case R.id.scenario_button8:
                Log.d("Ket", "ScenarioIconClickListener "+view.getId()+" 8");
        ...
        String spinnerPrompt = createEventActivity.getResources().getString(R.string.step2_question);
        Spinner spinner_step2_question = (Spinner) createEventActivity.findViewById(R.id.spinner_step2_question);
