...
import ubicomp.rehabdiary.utility.data.download.UserLevelCollector;
...
//import ubicomp.ketdiary.data.download.UserLevelCollector;
...
public class AnalysisRankView extends StatisticPageView {
	...
	private LayoutParams paramMonth, paramWeek;
...
//		this.showRadarChart = showRadarChart;
	...
	private class NetworkTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... arg0) {
			levelCollector = new UserLevelCollector(context);
