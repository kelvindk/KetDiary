 ...
 */
public class TestStateSalivaPropagating extends TestStateTransition {

    public TestStateSalivaPropagating(SalivaTestAdapter salivaTestAdapter) {
    ...
    public TestStateTransition transit(int trigger) {
        ...
        switch (trigger) {
            case BLE_NO_CASSETTE_PLUGGED:
                Log.d("TestState", "TestStateSalivaPropagating BLE_NO_CASSETTE_PLUGGED");
            ...
            case BLE_DEVICE_DISCONNECTED:
                Log.d("TestState", "TestStateSalivaPropagating BLE_DEVICE_DISCONNECTED");
            ...
            case BLE_CASSETTE_PLUGGED:
                Log.d("TestState", "TestStateSalivaPropagating "+trigger);
                newState = this;
                break;
