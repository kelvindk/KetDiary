package ubicomp.ketdiary.test.color;
...
import ubicomp.ketdiary.test.bluetoothle.modified_svm_predict;
import ubicomp.ketdiary.test.bluetoothle.modified_svm_scale;
